...
$use_smtp = 'smtp.totalcomunicacao.com.br';
$emailto = 'junior@totalcomunicacao.com.br';
  ...
  $smtp->debug = true; /*ativa a autenticacao SMTP */
	...
	$subject = 'Email do meu site novo';
	$message = '<b>Esta mensagem é um teste da <font color=red>total comunicação.</font><</b><br />';
	$response = '';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Obrigado!. A sua mensagem foi enviada com sucesso.';
